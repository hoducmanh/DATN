...
while True:
    ...
    #         # tạo ma trận toàn hệ số 1 sau đó nhân với 255 => 1 ảnh trắng 3 màu RGB
    #         imgCrop = img[y - offset:y + h + offset, x - offset:x + w + offset] 
    #         # cắt ảnh lấy 1 ma trận con chỉ chứa tay
    
    #         imgCropShape = imgCrop.shape 
    #         #trả về hình dáng của ảnh bao gồm chiều dài rộng và số kênh màu
